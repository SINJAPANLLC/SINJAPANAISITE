...
const STATS = [
  { target: 500, suffix: "社", label: "導入実績企業数", note: "※2026年2月時点" },
  { target: 100, suffix: "%", label: "顧客満足度", note: "※社内アンケート調査より" },
  { target: 2024, suffix: "年", label: "設立", note: "※SIN JAPAN AI 創業" },
];

function StatItem({ target, suffix, label, note, delay }: {
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-bold text-gray-300 tracking-wider mb-1">{label}</span>
...
export function Stats() {
  return (
    <section id="stats" className="py-24 bg-gray-950 text-white border-t border-white/5">
